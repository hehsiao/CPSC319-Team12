...
User.delete_all
User.create!([
	{id: 1, email: "admin@a.a", password: "12341234", first_name: "Jane", last_name: "Adminseed", admin: "1"},
	{id: 2, email: "user@a.a", password: "12341234", first_name: "Jonny", last_name: "Appleseed", admin: "0"},
